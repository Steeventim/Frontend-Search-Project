...
interface ProcessStepCardProps {
  ...
  previousStepAttachments?: Attachment[]; // Ajout de la propriété pour les pièces jointes de l'étape précédente
}
...
export const ProcessStepCard: React.FC<ProcessStepCardProps> = ({
  ...
  onApprove,
  onReject,
  previousStepAttachments = [], // Valeur par défaut vide
}) => {
    ...
    <Card className={`${isCurrentStep ? "border-2 border-blue-500" : ""}`}>
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-sm text-gray-500">Assigné à: {step.assignedTo}</p>
        </div>
