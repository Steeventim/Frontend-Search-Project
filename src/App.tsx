    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path={ROUTES.ADMIN.ROOT} element={<AdminLayout />}>
          ...
          <Route path={ROUTES.ADMIN.DEPARTMENTS} element={<DepartmentsList />} />
          <Route path={ROUTES.ADMIN.PROCESSES} element={<ProcessTemplatesList />} />
        ...
        <Route path={ROUTES.USER.ROOT} element={<UserLayout />}>
          ...
          <Route path={ROUTES.USER.PROCESS_DETAILS} element={<ProcessDetails />} />
